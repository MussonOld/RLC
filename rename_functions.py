...
ENTRIES = [
    ...
    ("0800d578", "FormulaRsRpLC", """[CONFIRMED, раздел 6.23/6.27, доп. 2026-09-14] Формула Rs/Rp/L/C(+X) — пишет вычисленные значения в структуру результата 0x20004a48: Rs(+0x30), Rp(+0x40), L(+0x90), C(+0x98), и (доп. 2026-09-14) X?(+0x38, копия +0x28) и RAW Z(+0x48, несглаженный источник экранного Z после сглаживания в FUN_08009618).""", "CONFIRMED"),
    ...
    ("08002ec0", "NormalizeChannels_probable", """[PROBABLE, раздел 6.12] Похоже на нормировку/взятие модуля по каналам корреляционного буфера 0x20007840 перед FUN_0800dbf8.""", "PROBABLE"),
